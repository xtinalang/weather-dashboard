...
class TestSearchTemplates:
    ...
    async def test_search_results_from_homepage(self, page: Page):
        ...
        await search_input.fill(SEARCH_QUERY_LONDON)
    ...
    async def test_search_with_multiple_results(self, page: Page):
        ...
        await search_input.fill("Springfield")  # Common city name in many countries
        await search_button.click()
    ...
    async def test_search_with_invalid_location(self, page: Page):
        ...
        await search_input.fill("NonExistentCityName12345")
        await search_button.click()
    ...
    async def test_search_with_empty_query(self, page: Page):
    ...
    async def test_nl_weather_query_today(self, page: Page):
        ...
        await nl_input.fill("What's the weather like in London today?")
        await nl_submit.click()
    ...
    async def test_nl_weather_query_tomorrow(self, page: Page):
        ...
        await nl_input.fill("How's the weather in Paris tomorrow?")
        await nl_submit.click()
    ...
    async def test_nl_weather_query_weekend(self, page: Page):
        ...
        await nl_input.fill("Weather for New York this weekend?")
        await nl_submit.click()
    ...
    async def test_nl_weather_query_specific_day(self, page: Page):
        ...
        await nl_input.fill("What's Tokyo weather like next Monday?")
        await nl_submit.click()
    ...
    async def test_nl_weather_query_invalid(self, page: Page):
        ...
        await nl_input.fill("weather stuff sometime maybe")
        await nl_submit.click()
    ...
    async def test_nl_weather_query_empty(self, page: Page):
    ...
    async def test_search_results_page_structure(self, page: Page):
        ...
        if (
            await "search" in page.url.lower()
            or page.locator(".search-results").is_visible()
        ):
    ...
    async def test_date_weather_results_display(self, page: Page):
        ...
        await nl_input.fill("London weather today")
        await nl_submit.click()
        ...
        if page.locator(".date-weather-results").is_visible():
            await expect(page.locator(".date-weather-results")).to_be_visible()

    async def test_search_with_international_characters(self, page: Page):
        ...
        await search_input.fill("München")  # Munich in German
        await search_button.click()
    ...
    async def test_search_with_special_characters(self, page: Page):
        ...
        await search_input.fill("São Paulo")  # City with special characters
        await search_button.click()
    ...
    async def test_search_case_insensitive(self, page: Page):
    ...
    async def test_search_with_coordinates(self, page: Page):
        ...
        await search_input.fill("51.5074,-0.1278")  # London coordinates
        await search_button.click()
    ...
    async def test_nl_weather_multiple_locations(self, page: Page):
        ...
        await nl_input.fill("Compare weather between London and Paris tomorrow")
        await nl_submit.click()
    ...
    async def test_search_and_navigation_flow(self, page: Page):
        ...
        if "weather" in page.url:
            ...
            if await forecast_link.is_visible():
    ...
    async def test_flash_messages_in_search_results(self, page: Page):
        ...
        await search_input.fill("InvalidLocationName12345")
        await search_button.click()
